...
const filePath = 'C:\\Users\\fabricio.lima\\OneDrive - HITSS DO BRASIL SERVIÇOS TECNOLOGICOS LTDA\\Área de Trabalho - Antiga\\Projetos React\\app-financeiro\\scripts\\extract_dre_metrics.js';
...
try {
  ...
  console.log('✅ Arquivo extract_dre_metrics.js criado com sucesso!');
  console.log('📊 Agora você pode executar o script com métricas de performance');
} catch (error) {
